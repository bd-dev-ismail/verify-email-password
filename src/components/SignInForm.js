import { FacebookAuthProvider, getAuth, GithubAuthProvider, signInWithEmailAndPassword, signInWithPopup, TwitterAuthProvider } from 'firebase/auth';
        ...
        <div className="flex justify-center my-2 mx-4 md:mx-0">
          <form className="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
            <div className="flex flex-wrap -mx-3 mb-6">
              ...
              <div className="w-full md:w-full px-3 mb-6">
                <button
                  onClick={handalSignIn}
                  className="appearance-none block w-full bg-blue-600 text-gray-100 font-bold py-
                3"
                >
                  Sign in
                </button>
